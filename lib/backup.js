...
// On shutdown, set a flag so next startup runs a backup (regardless of 24h interval).
// We can't reliably finish a full backup during page unload, so the next-startup
// pickup is the dependable mechanism.
